...
emissions due to tree management citep:nowak_e_02.  Though, in the short-term, the
greater atmospheric C sequestration at the expense of a smaller
magnitude fossilized C emission may be beneficial The avoided ACE
...
that for cool climate communities, trees actually
...
effects, however uncertain they might be.  We also fit models We fit models using the R
